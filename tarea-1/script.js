...
$botonEmpezarDeNuevo.onclick = function(e, elementoForm = $formulario) {
	...
	eliminarElementos(elementoForm, $edadesFamilia, $botonCalcular, $botonEmpezarDeNuevo, $separadores);
	borrarMensajes();
	agregarElementos();
	return false;
}
